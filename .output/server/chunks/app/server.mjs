...
import { u as useRuntimeConfig$1, d as defu } from '../defu.mjs';
import 'destr';
import 'scule';
...
const _routes = [
  {
    ...
    component: () => import('./_nuxt/index-f34541f2.mjs').then((m) => m.default || m)
  }
];
...
const _sfc_main = {
  ...
  setup(__props) {
    const ErrorComponent = defineAsyncComponent(() => import('./_nuxt/error-component-c5ca5249.mjs').then((r) => r.default || r));
